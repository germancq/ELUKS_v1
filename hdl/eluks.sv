  ...
  always_comb begin
    ...
    case (current_state)
      ...
      /*
            ...
            */
      SEL_FIRST_ENCRYPTED_BLOCK: begin
        rst_hmac = 1'b0;
      ...
      WAIT_BUSY_HMAC_0: begin
        rst_hmac = 1'b0;
        eluks_r_multi_block = 1;
        if (busy_hmac == 1) next_state = WAIT_BUSY_HMAC_1;
      end
      WAIT_BUSY_HMAC_1: begin
        rst_hmac = 1'b0;
        eluks_r_multi_block = 1;
